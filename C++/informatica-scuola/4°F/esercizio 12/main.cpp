//Vito Barra
///esercizio 12
///avendo una lista di nomi e orari creare una nuova lista senza ripetizioni
#include <iostream>
#include <string>
using namespace std;
...
void NuovaLista()
{
	...
	while (Lptr != nullptr)
	{
		...
		NewLista->next->orario = Lptr->orario;
